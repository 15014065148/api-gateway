package com.eveb.gateway.game.agin.model;
...
public class AginConstants {
	...
	/**检测并创建游戏账号**/
	public static final String AGIN_FUN_CHECKORCREATEGAMEACCOUT ="cagent=%s/\\\\/loginname=%s/\\\\/method=lg/\\\\/actype=1/\\\\/password=123456/\\\\/cur=CNY";
	/**预备转账**/
	public static final String AGIN_FUN_PREPARETRANSFERCREDIT="cagent=%s/\\\\/loginname=%s/\\\\/method=tc/\\\\/billno=%s/\\\\/type=%s/\\\\/credit=%s/\\\\/actype=1/\\\\/password=123456/\\\\/cur=CNY";
	/**转账确认**/
	public static final String AGIN_FUN_TRANSFERCREDITCONFIRM="cagent=%s/\\\\/loginname=%s/\\\\/method=tcc/\\\\/billno=%s/\\\\/type=%s/\\\\/credit=%s/\\\\/actype=1/\\\\/flag=%s/\\\\/password=123456/\\\\/cur=CNY";
	/**余额查找**/
	public static final String AGIN_FUN_GETBALANCE="cagent=%s/\\\\/loginname=%s/\\\\/method=gb/\\\\/actype=1/\\\\/password=123456/\\\\/cur=CNY";
	/**状态查询**/
	public static final String AGIN_FUN_QUERYORDERSTATUS="cagent=%s/\\\\/billno=%s/\\\\/method=qos/\\\\/actype=1/\\\\/password=123456/\\\\/cur=CNY";
	public static final String AGIN_M_DOBUSINESS = "doBusiness.do?";
	public static final String AGIN_M_FORWARDGAME = "forwardGame.do?";
	public static final String AGIN_FUN_DEPOSIT="IN";//转入
	public static final String AGIN_FUN_WITHDRAW="OUT";//转入
